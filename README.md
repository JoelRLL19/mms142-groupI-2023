...
<p>
•	Initially, these innovations may offer different qualities compared to existing solutions and may perform worse in one or two aspects that current customers of established companies value.
•	Additionally, these innovations might not seem financially appealing to established companies.
•	Lastly, predicting the future market and understanding these disruptive innovations can be hard, which increases the risk and makes them less financially attractive.</p>
...
<p>Secondly, AR allows offers new ways for its users to interact both with each other, and their envrionment through immersive processes, such as apps
